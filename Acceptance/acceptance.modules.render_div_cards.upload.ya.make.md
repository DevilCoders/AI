```cmake
# Define a Python 3 program target
PY3_PROGRAM()
...
PEERDIR(
    ...
    # Include the "ijson" Python library for iterative JSON parsing
    contrib/python/ijson
    # Include the "jsonschema" Python library for validating JSON data
    contrib/python/jsonschema
    # Include the "requests" Python library for making HTTP requests
